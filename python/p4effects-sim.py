...
sim = dose_response({'lbl' : 'model'   , 'slevel' : 'StotNative' }).append(
      ...
      dose_response({'lbl' : 'highsig' , 'slevel' : 'StotNative' , 'p4n' : 0 , 'p4m' : 0.1 })).append(
      dose_response({'lbl' : 'highsig' , 'slevel' : 'StotOE'     , 'p4n' : 0 , 'p4m' : 0.1 })).append(
      dose_response({'lbl' : 'lowsig'  , 'slevel' : 'StotNative' , 'p4n' : 0 , 'p4m' : 150 })).append(
      dose_response({'lbl' : 'lowsig'  , 'slevel' : 'StotOE'     , 'p4n' : 0 , 'p4m' : 150 }))
