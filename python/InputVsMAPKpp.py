...
ax.plot( sim.index , sim['MAPKpp']['StotNative'] , label='Native'        , color=color_native )
ax.plot( sim.index , sim['MAPKpp']['StotOE']     , label='Overexpressed' , color=color_oe )
ax.legend()
...
ax.plot( sim.index , sim['MI']['StotNative'] , label='Native'        , color=color_native )
ax.plot( sim.index , sim['MI']['StotOE']     , label='Overexpressed' , color=color_oe )
ax.legend()
...
ax.set_xlim(auto=True)
ax.set_ylim(auto=True)
ax.plot( sim.index , dSmem['StotNative'] , label='Native'        , color=color_native )
ax.plot( sim.index , dSmem['StotOE']     , label='Overexpressed' , color=color_oe )
ax.legend(loc='center right')
showfig(-1)
#}}}
...
ax.set_xlim(auto=True)
ax.set_ylim(auto=True)
ax.plot( sim.index , sim['Sves[0]']['StotNative'] , label='Native'        , color=color_native )
ax.plot( sim.index , sim['Sves[0]']['StotOE']     , label='Overexpressed' , color=color_oe )
ax.legend(loc='center right')
showfig()
